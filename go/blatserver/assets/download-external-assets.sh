...
#
wget https://vectorbase.org/common/downloads/Current_Release/AaegyptiLVP_AGWG/fasta/data/VectorBase-49_AaegyptiLVP_AGWG_Genome.fasta
...
#
wget https://vectorbase.org/common/downloads/Current_Release/AgambiaePEST/fasta/data/VectorBase-49_AgambiaePEST_Genome.fasta
echo "Standardizing the chromosome names..."
echo "...AgamP4_2L"
